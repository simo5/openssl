...
/*
 * RH: test data replaced to use proper FFDH2048 keys that pass
 * fullpublic key checks.
 * Test vectors from:
 * https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/KAS-FFC-SSC-Sp800-56Ar3/internalProjection.json
 * RELEASE/v1.1.0.41
 */
static const unsigned char dh_priv[] = {
    
};
static const unsigned char dh_pub[] = {
    
};
static const unsigned char dh_peer_pub[] = {
    
};

static const unsigned char dh_secret_expected[256] = {
    
};
...
static const ST_KAT_PARAM rsa_enc_params[] = {
    ...
    ST_KAT_PARAM_OCTET(OSSL_ASYM_CIPHER_PARAM_REDHAT_KAT_OAEP_SEED,
                       oaep_fixed_seed),
    ST_KAT_PARAM_END()
};
